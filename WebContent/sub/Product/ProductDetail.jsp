                	...
                	<div class="item_photo_big">
                    	<span class="img_photo_big">
                    		<a href="#lyZoom" id="mainImage" class="zoom_layer_open btn_open_layer">
                    			<img src="<%=path%>/images/big_image.jpg" id="bigImage" width="640" height="500" alt="[신제품] 볼볼홈파티 디저트플레이트 18cm (5color)" title="[신제품] 볼볼홈파티 디저트플레이트 18cm (5color)" class="middle">
                    		</a>
                    	</span>
                    	<a href="#lyZoom" class="btn_zoom zoom_layer_open btn_open_layer">
                    		<img src="<%=path%>/images/find.jpg" alt="">
                    	</a>
                	</div>
                	<div id="testZoom" style="display:none">
                		<img src="<%=path%>/images/big_image.jpg" width="640" height="600" alt="[신제품] 볼볼홈파티 디저트플레이트 18cm (5color)" title="[신제품] 볼볼홈파티 디저트플레이트 18cm (5color)" class="middle">
                	</div>
                    <!-- //item_photo_big -->
                        ...
                        <div class="slick-list draggable">
                        	<div class="slick-track" style="left:100px" width="1768px" role="listbox">
                        		...
                        		<li class="slick-slide slick-cloned" style="width:84px; float:left;">
                        			<img style="cursor:pointer;" src="<%=path%>/images/detail_img1.jpg" onclick="showBig(this.src)" width="68" alt="[신제품] 볼볼홈파티 디저트플레이트 18cm (5color)" title="[신제품] 볼볼홈파티 디저트플레이트 18cm (5color)" class="middle">
                        		</li>
                        		<li class="slick-slide slick-cloned" style="width: 84px; float:left;">
                        			<img style="cursor:pointer;" src="<%=path%>/images/detail_img2.jpg" onclick="showBig(this.src)"  width="68" alt="[신제품] 볼볼홈파티 디저트플레이트 18cm (5color)" title="[신제품] 볼볼홈파티 디저트플레이트 18cm (5color)" class="middle">
                        		</li>
                        		<li class="slick-slide slick-cloned" style="width: 84px; float:left;">
	                        		<img style="cursor:pointer;" src="<%=path%>/images/detail_img3.jpg" onclick="showBig(this.src)"  width="68" alt="[신제품] 볼볼홈파티 디저트플레이트 18cm (5color)" title="[신제품] 볼볼홈파티 디저트플레이트 18cm (5color)" class="middle">
                        		</li>
                        		<li class="slick-slide slick-cloned" style="width: 84px; float:left;">
	                        		<img style="cursor:pointer;" src="<%=path%>/images/detail_img4.jpg" onclick="showBig(this.src)"  width="68" alt="[신제품] 볼볼홈파티 디저트플레이트 18cm (5color)" title="[신제품] 볼볼홈파티 디저트플레이트 18cm (5color)" class="middle">
                        		</li>
                        		<li class="slick-slide slick-cloned" style="width: 84px; float:left;">
	                        		<img style="cursor:pointer;" src="<%=path%>/images/detail_img5.jpg" onclick="showBig(this.src)"  width="68" alt="[신제품] 볼볼홈파티 디저트플레이트 18cm (5color)" title="[신제품] 볼볼홈파티 디저트플레이트 18cm (5color)" class="middle">
                        		</li>
                        		</ul>
                        		<!-- ::after -->
                        	</div>
