...
<jsp:include page="../../main_upper.jsp" flush="false"/>
      ...
      <div class="main_b1_plist">
         ...
         <div class="b1_list">
            ...
            <div class="list" style="margin: 0px 10px 0px 10px; text-align:center;">
               <a href="../Product/ProductDetail.jsp"><img src="<%=path %>/<%=plist.get(i).getProduct_img_src()%>"/></a>
               <div class="pInfo"><%=plist.get(i).getProduct_name()%></div>
               <div class="pPrice">가격 : <%=plist.get(i).getProduct_price()%></div>
            </div>
            <%} %>
            <%--
