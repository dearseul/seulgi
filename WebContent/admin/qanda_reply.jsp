...
<body>
	<div id="content">
		<div id="write">
			<div id="qanda_text">문의게시판 답글쓰기</div>
			<form>
				<table id="write_tab">
					<tr><th>문의ID</th><td><input id="input_id" type="text" name="qid"></td>
					    <th>분류</th><td><input id="input_qcat" type="text" name="qcat"></td></tr>
					<tr><th>답글작성자ID</th><td><input id="input_id" type="text" name="id"></td>
					    <th>답글작성일자</th><td><input id="input_qdate" type="text" name="qdate"></td></tr>
