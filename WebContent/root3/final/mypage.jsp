   ...
   <div id="mypage">
        <section class="left-profile">
            ...
            <div class="wrap-img-profile">
                <img class="img-profile" src="../image_csg/img_profile.png" alt="">
            </div>
        ...
        <section class="right-order">
            <div class="box-order">
                ...
                <div class="order-detail">
                    ...
                    <div class="prod-order">
                        <a href="NewFile.jsp"><img class="img-order" src="../image_csg/list_img2.jpg" alt=""></a>
            ...
            <div class="box-order">
                ...
                <div class="order-detail">
                    <div class="status-order">배송완료<span class="date-arrive">1/16 도착</span></div>
                    <div class="prod-order">
                        <img class="img-order" src="../image_csg/list_img2.jpg" alt="">
                        <div class="text-order">
                            <p class="prod-name">커클랜드 베이글 어니언</p>
                            <p class="order-price">9000원</p><p class="order-cnt">1개</p>
                        </div>
