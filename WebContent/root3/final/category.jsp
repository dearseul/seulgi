        ...
        <section class="content-right">
            <div class="comm-slider">
                ...
                <div class="swiper-container container-slider-comm">
                    ...
                    <div class="swiper-slide"><img class="img-comm" src="../image_csg/comm_img1.jpg" alt=""></div>
                    <div class="swiper-slide"><img class="img-comm" src="../image_csg/comm_img2.jpg" alt=""></div>
                    <div class="swiper-slide"><img class="img-comm" src="../image_csg/comm_img3.jpg" alt=""></div>
                    <div class="swiper-slide"><img class="img-comm" src="../image_csg/comm_img4.jpg" alt=""></div>
                    <div class="swiper-slide"><img class="img-comm" src="../image_csg/comm_img5.jpg" alt=""></div>
                    <div class="swiper-slide"><img class="img-comm" src="../image_csg/comm_img6.jpg" alt=""></div>
                    </div>
                ...
                <div class="swiper-container container-slider-sale">
                    ...
                    <div class="swiper-slide">
                      <div class="prd-content-list">
                            <div class="prd-img"><img src="../image_csg/list_img1.jpg" alt=""></div>
                            <div class="prd-text">
                    ...
                    <div class="swiper-slide">
                        <div class="prd-content-list">
                              <div class="prd-img"><img src="../image_csg/list_img2.jpg" alt=""></div>
                              <div class="prd-text">
                                  <h6 class="brand">보울보울</h6>
                                  <h5 class="title">볼볼홈파티 주병세트</h5>
                                  <h4 class="price"><span class="percent-price">35%</span><span class="price-dis">36900원</span></h4>
                      ...
                      <div class="swiper-slide">
                        <div class="prd-content-list">
                              <div class="prd-img"><img src="../image_csg/list_img3.jpg" alt=""></div>
                              <div class="prd-text">
                                  <h6 class="brand">보울보울</h6>
                                  <h5 class="title">볼볼홈파티 주병세트</h5>
                                  <h4 class="price"><span class="percent-price">35%</span><span class="price-dis">36900원</span></h4>
                      ...
                      <div class="swiper-slide">
                        <div class="prd-content-list">
                              <div class="prd-img"><img src="../image_csg/list_img4.jpg" alt=""></div>
                              <div class="prd-text">
                                  <h6 class="brand">보울보울</h6>
                                  <h5 class="title">볼볼홈파티 주병세트</h5>
                                  <h4 class="price"><span class="percent-price">35%</span><span class="price-dis">36900원</span></h4>
                      ...
                      <div class="swiper-slide">
                        <div class="prd-content-list">
                              <div class="prd-img"><img src="../image_csg/list_img5.jpg" alt=""></div>
                              <div class="prd-text">
                                  <h6 class="brand">보울보울</h6>
                                  <h5 class="title">볼볼홈파티 주병세트</h5>
                                  <h4 class="price"><span class="percent-price">35%</span><span class="price-dis">36900원</span></h4>
                      ...
                      <div class="swiper-slide">
                        <div class="prd-content-list">
                              <div class="prd-img"><img src="../image_csg/list_img6.jpg" alt=""></div>
                              <div class="prd-text">
                                  <h6 class="brand">보울보울</h6>
                                  <h5 class="title">볼볼홈파티 주병세트</h5>
                                  <h4 class="price"><span class="percent-price">35%</span><span class="price-dis">36900원</span></h4>
